...
For the lighter TypeScript app path during development, you can also run:

```bash
npm run dev -- --provider openrouter "summarize this project"
```

Or point the newer app path at Ollama:
